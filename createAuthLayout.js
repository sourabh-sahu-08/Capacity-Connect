...
const authBrandPanelContent = `import React from 'react';
...
fs.writeFileSync('client/src/components/auth/AuthBrandPanel.tsx', authBrandPanelContent, 'utf8');
fs.writeFileSync('client/src/components/auth/AuthLayout.tsx', authLayoutContent, 'utf8');
