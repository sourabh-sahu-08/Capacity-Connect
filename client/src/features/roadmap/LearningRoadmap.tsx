      ...
      <div className="relative">
        ...
        <div className="space-y-8">
          <div className="flex gap-6 items-start">
            <div className="w-16 h-16 rounded-full bg-purple-900/30 border-2 border-purple-500 flex flex-col items-center justify-center shrink-0 shadow-[0_0_15px_rgba(99,102,241,0.5)] z-10 text-purple-600 font-bold uppercase text-xs">Start</div>
            ...
            >
              <div className="w-16 flex justify-center z-10">
                {step.status === 'Completed' ? (
                  ...
                  <Circle className="text-purple-600 w-8 h-8 fill-purple-900/50 bg-slate-50 rounded-full" />
                ) : (
              ...
              <div className={`flex-1 p-6 rounded-xl border transition-all ${
                ...
                step.status === 'InProgress' ? 'bg-white border-purple-500/50 shadow-[0_0_20px_rgba(99,102,241,0.1)] transform hover:-translate-y-1' :
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className={`text-xs px-2 py-1 rounded font-medium ${
                    ...
                    step.status === 'InProgress' ? 'bg-purple-100 text-purple-600' :
          ...
          <div className="flex gap-6 items-center pt-4">
            <div className="w-16 flex flex-col items-center z-10">
              <ArrowDown className="text-purple-500 mb-4 animate-bounce" />
              <div className="w-16 h-16 rounded-full bg-purple-600 shadow-[0_0_15px_rgba(147,51,234,0.5)] border-4 border-zinc-950 flex flex-col items-center justify-center shrink-0 shadow-[0_0_20px_rgba(99,102,241,0.8)] z-10 text-white font-bold text-2xl">🎯</div>
            </div>
            <div className="flex-1 p-6">
              <div className="text-sm text-purple-600 font-bold uppercase tracking-widest mb-1">Target Role</div>
