...
import { Presentation, Users, BookOpen, FileCheck, BarChart3, Lightbulb, Bell, Settings, LogOut } from 'lucide-react';
...
fs.writeFileSync('client/src/layouts/TrainerSidebar.tsx', sidebarContent, 'utf8');
fs.writeFileSync('client/src/layouts/TrainerLayout.tsx', layoutContent, 'utf8');
